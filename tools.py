...
TAGALL = [
    ...
    "💕 Kya baat hai cuties, aaj kitne sundar lag rahe ho!",
    "🌹 Good morning beauties! Aaj ka din tumhare jaise hi khoobsurat ho!",
    "😘 Miss me? Of course you did! Main aa gaya hun 💫",
    "🥰 Hey gorgeous people! Tumhe dekh kar din ban gaya!",
    ...
    "🎶 Music on, vibe on! Let's make some memories today!",
    "🌟 Shining bright like diamonds! That's all of you ✨",
    "💫 Kya scene hai? Someone looking extra cute today 😍",
    "🔥 Hot people alert! Temperature badh gaya group mein 🌡️",
    "💕 Pyaar mohabbat ka mahaul hai aaj! Love is in the air!",
    "😎 Cool gang assembled! Let's make this day epic!",
    ...
    "🌙 Chand si khubsurti hai tumhari! Moonlight bhi sharmaye!",
    ...
    "🌈 Rainbow after rain! That's how I feel when you're all here!",
    "😍 Can't stop staring! Beauty overload in this group!",
    "💖 Heartbeat skip kar gaya seeing you all active!",
    "🥰 Cuddle weather! Wish I could hug you all right now!",
    ...
    "🌙 Moonlight dinner ke mood mein! Anyone hungry for love?",
    ...
    "😘 Kiss cam activated! Everyone looks kissable today!",
    ...
    "💝 Valentine's day everyday! Romance never ends here!",
    ...
    "🌙 Sweet dreams material! You all are dream come true!",
    "🥳 Celebration nation! Every day is festival with you guys!",
    "💖 Heartbeat symphony! Creating music with your presence!",
    "🌺 Bouquet of happiness! Fresh and fragrant like you all!",
    "😘 Lip sync battle! Everyone's got kissable lips today!",
    "✨ Magic wand wave! And poof! Perfect people appeared!",
    "🦋 Metamorphosis complete! You all transformed my day!",
    ...
    "🥰 Sunshine on a cloudy day! That's what you are to me!",
