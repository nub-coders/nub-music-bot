...
queue_styles = UniformFormat("""Added to Queue
Mode: {}
Title: {}
Length: {}
Position: #{}""")

play_styles = UniformFormat("""Now Playing
Mode: {}
Title: {}
Length: {}
Requested by: {}""")
...
async def join_call(message, title, youtube_link, chat, by, duration, mode, thumb, stream_url=None):
    ...
    try:
        ...
        if not stream_source:
            ...
            await clients["bot"].send_message(chat.id, "ERROR: Could not find a valid stream source.", disable_web_page_preview=True)
